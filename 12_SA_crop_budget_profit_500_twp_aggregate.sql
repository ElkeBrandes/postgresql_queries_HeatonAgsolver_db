...
DROP TABLE IF EXISTS "profit-120_500_sa_totals";
CREATE TABLE "profit-120_500_sa_totals"
AS SELECT
twpid,
sum(clumuacres::numeric)/2.471 AS "profit-120_2015_ha"
FROM "profit-120_500_sa"
GROUP BY twpid;

DROP TABLE IF EXISTS "profit-90_500_sa_totals";
CREATE TABLE "profit-90_500_sa_totals"
AS SELECT
twpid,
sum(clumuacres::numeric)/2.471 AS "profit-90_2015_ha"
FROM "profit-90_500_sa"
GROUP BY twpid;

DROP TABLE IF EXISTS "profit-60_500_sa_totals";
CREATE TABLE "profit-60_500_sa_totals"
AS SELECT
twpid,
sum(clumuacres::numeric)/2.471 AS "profit-60_2015_ha"
FROM "profit-60_500_sa"
GROUP BY twpid;

DROP TABLE IF EXISTS "profit-30_500_sa_totals";
CREATE TABLE "profit-30_500_sa_totals"
AS SELECT
twpid,
sum(clumuacres::numeric)/2.471 AS "profit-30_2015_ha"
FROM "profit-30_500_sa"
GROUP BY twpid;

DROP TABLE IF EXISTS "profit_2015_500_sa_totals";
CREATE TABLE "profit_2015_500_sa_totals"
AS SELECT
twpid,
sum(clumuacres::numeric)/2.471 AS "profit_2015_ha"
FROM "profit_2015_500_sa"
GROUP BY twpid;
...
LEFT OUTER JOIN "profit-120_500_sa_totals" t2
...
FROM sa_join1 t1
LEFT OUTER JOIN "profit-90_500_sa_totals" t2
ON t1.twpid = t2.twpid;
...
FROM sa_join2 t1
LEFT OUTER JOIN "profit-60_500_sa_totals" t2
ON t1.twpid = t2.twpid;
...
FROM sa_join3 t1
LEFT OUTER JOIN "profit-30_500_sa_totals" t2
ON t1.twpid = t2.twpid;
...
t2."profit_2015_ha"
FROM sa_join4 t1
LEFT OUTER JOIN "profit_2015_500_sa_totals" t2
ON t1.twpid = t2.twpid;
...
DROP TABLE IF EXISTS profit_500_sa_township_2015_cashrents;
CREATE TABLE profit_500_sa_township_2015_cashrents
AS SELECT
t1.*,
t2."profit+120_2015_ha"
FROM sa_join8 t1
...
UPDATE profit_500_sa_township_2015_cashrents
...
DROP TABLE IF EXISTS profit_500_sa_township_2015_cashrents_r;
CREATE TABLE profit_500_sa_township_2015_cashrents_r
AS SELECT * FROM profit_500_sa_township_2015_cashrents;
